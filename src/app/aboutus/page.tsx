    ...
    <ProtectedRoute>
      <div className="w-full max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-12 sm:space-y-16">
        ...
        <div className="text-center space-y-3">
          <h1 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">{t.about.title}</h1>
          <p className="text-xs sm:text-base text-[#94A3B8] max-w-2xl mx-auto">
            {t.about.subtitle}
          </p>
        </div>

        <div className="border border-blue-500/20 bg-[#121826]/70 backdrop-blur-xl p-6 sm:p-10 rounded-2xl shadow-[0_0_30px_-5px_rgba(59,130,246,0.15)] relative overflow-hidden">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 sm:gap-8">
            ...
            <div className="space-y-4 text-center md:text-left flex-1">
              <div>
                ...
                <p className="text-xs text-[#94A3B8] font-mono mt-0.5">{t.about.founderRole}</p>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[#94A3B8]">{t.about.discordDesc}</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[#94A3B8]">{t.about.fbDesc}</p>
              </div>
            </a>
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[#94A3B8]">{t.about.tiktokDesc}</p>
              </div>
            </a>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="border border-white/10 bg-[#121826]/70 backdrop-blur-xl p-5 sm:p-6 rounded-2xl space-y-3">
            ...
            <h3 className="text-base font-bold text-white">{t.about.coreTech}</h3>
            <p className="text-xs text-[#94A3B8] leading-relaxed">{t.about.coreTechDesc}</p>
          </div>

          <div className="border border-white/10 bg-[#121826]/70 backdrop-blur-xl p-5 sm:p-6 rounded-2xl space-y-3">
            <Zap className="w-6 h-6 text-indigo-400" />
            <h3 className="text-base font-bold text-white">{t.about.nextGen}</h3>
            <p className="text-xs text-[#94A3B8] leading-relaxed">{t.about.nextGenDesc}</p>
          </div>

          <div className="border border-white/10 bg-[#121826]/70 backdrop-blur-xl p-5 sm:p-6 rounded-2xl space-y-3">
            <Shield className="w-6 h-6 text-cyan-400" />
            <h3 className="text-base font-bold text-white">{t.about.scalability}</h3>
            <p className="text-xs text-[#94A3B8] leading-relaxed">{t.about.scalabilityDesc}</p>
          </div>
        </div>
