...
import { ArrowRight, Sparkles, Layers, Star, ExternalLink, Cpu } from 'lucide-react';
          ...
          {activeApps.map((app) => (
            ...
            >
              <div className="space-y-4">
                ...
                <div>
                  <div className="text-[10px] tracking-wider uppercase font-semibold text-blue-400 mb-1">
                    {app.category}
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg border border-white/10 bg-[#090D16] p-1.5 flex items-center justify-center">
                      <img
                        ...
                        onError={(e) => {
                          e.currentTarget.style.display = 'none';
                          e.currentTarget.parentElement!.innerHTML = '<svg class="w-4 h-4 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>';
                        }}
                      />
                    </div>
                    <span
